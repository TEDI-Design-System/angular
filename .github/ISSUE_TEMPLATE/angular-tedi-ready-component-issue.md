...
- [ ] The component has **unit tests** with at least **80% code coverage** _(enforced by the global Jest `coverageThreshold` over `tedi/components`, not per component)_
...
- [ ] Update the **Angular** development status on the [statuses page in Zeroheight](https://www.tedi.ee/1ee8444b7/p/300e17-komponentide-staatused)
