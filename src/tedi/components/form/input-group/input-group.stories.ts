...
const meta: Meta<InputGroupComponent> = {
  ...
  argTypes: {
    ...
    invalid: {
      description:
        "Marks the whole group as invalid. Pair with an error feedback text.",
      control: "boolean",
      table: {
        type: { summary: "boolean" },
        defaultValue: { summary: "false" },
...
const ACCOUNTS = [
  {
    value: "checking",
    name: "Arvelduskonto",
    number: "EE38 2200 2210 2014 5685",
  },
  {
    value: "savings",
    name: "Kogumiskonto",
    number: "EE96 2200 2210 2014 7283",
  },
  {
    value: "investment",
    name: "Investeerimiskonto",
    number: "EE27 2200 2210 2014 8120",
  },
];
const MEETINGS = [
