  ...
  render: () => ({
    props: {
      ...
      endControl: new FormControl(
        longLabelOptions.map((option) => option.value),
      ),
      startControl: new FormControl(
        longLabelOptions.map((option) => option.value),
      ),
      multiRowControl: new FormControl(
        longLabelOptions.map((option) => option.value),
      ),
    },
    template: `
  ...
  render: () => ({
    props: {
      ...
      groupedOptions: [
        {
          id: 1,
          name: "Erakorralise meditsiini osakond",
          category: "Erakorraline",
        },
      ...
      descriptionOptions: [
        ...
        },
        {
          ...
          description: "Arstid näevad teie ravimeid ja terviseandmeid",
        },
        {
          id: 3,
  ...
  accessOptions = [
    {
      id: 1,
      title: "Terviseandmed",
      description: "Juurdepääs terviseandmetele",
    },
    { id: 2, title: "Ravimid", description: "Juurdepääs ravimite ajaloole" },
    {
      id: 3,
      title: "Analüüside tulemused",
      description: "Juurdepääs laborianalüüside tulemustele",
    },
  ];
...
class SelectCustomSearchDemoComponent {
  options: PermissionOption[] = [
    ...
    {
      id: 4,
      title: "Kustutamisõigused",
      description: "Saab eemaldada dokumente ja andmeid",
    },
  ];
      ...
      >
        @if (events().length === 0) {
          <span style="color: var(--general-text-tertiary);"
            >Kasuta valikmenüüd, et näha sündmusi.</span
          >
        } @else {
