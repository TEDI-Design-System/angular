...
export default {
  ...
  argTypes: {
    ...
    minuteStep: {
      description:
        "Minute increment for the scroll variant — e.g. 5 renders 00, 05, 10…",
      control: { type: "number" },
      table: {
        category: "inputs",
        type: { summary: "number" },
    ...
    timeSlots: {
      description:
        "Predefined HH:mm strings rendered by the slots and dropdown variants.",
      control: { type: "object" },
      table: {
        category: "inputs",
        type: { summary: "string[]" },
    ...
    border: {
      description:
        "Render the picker with a surrounding border — useful when the picker is embedded inside other content and needs to visually stand apart.",
      control: { type: "boolean" },
      table: {
        category: "inputs",
        type: { summary: "boolean" },
...
export const Bordered: StoryObj = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Enable `[border]="true"` to render the picker with a surrounding border. Useful when embedding the picker into other content where it needs to visually stand apart from the surroundings.',
      },
    },
  },
};
...
export const Slots: StoryObj = {
  render: () => ({
    ...
    template: `
      <tedi-row cols="1" [md]="{ cols: 2 }" [gapY]="3">
        <tedi-col>
          <p tedi-text modifiers="small bold">Without indicator</p>
          <tedi-time-picker
            variant="slots"
            value="11:30"
            [timeSlots]="slots"
        ...
        <tedi-col>
          <p tedi-text modifiers="small bold">With indicator</p>
          <tedi-time-picker
            variant="slots"
            value="11:30"
            [timeSlots]="slots"
