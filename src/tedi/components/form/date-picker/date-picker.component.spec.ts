...
describe("DatePickerComponent NG_VALUE_ACCESSOR integration", () => {
  ...
  beforeEach(() => {
    ...
    datePicker = fixture.debugElement.query(By.directive(DatePickerComponent))
  ...
  it("should handle initial FormControl value", () => {
    ...
    newFixture.componentInstance.control.setValue(initialDate, {
      emitEvent: false,
    });
    newFixture.detectChanges();
