...
describe("SideNavItemComponent", () => {
  ...
  it("should register on init and unregister on destroy", () => {
    expect(sidenavService.registerItem).toHaveBeenCalledWith(
      fixture.componentInstance,
    );
    fixture.destroy();
    expect(sidenavService.unregisterItem).toHaveBeenCalledWith(
      fixture.componentInstance,
    );
  });
  ...
  it("should add selected class when selected input is true", () => {
    ...
    fixture.detectChanges();
    itemElement = fixture.nativeElement.querySelector("li");
    expect(itemElement.classList.contains("tedi-sidenav-item--selected")).toBe(
      true,
    );
  });
  ...
  it("should add hidden class when mobile item open and no dropdown open", () => {
    ...
    fixture.detectChanges();
    itemElement = fixture.nativeElement.querySelector("li");
    expect(itemElement.classList.contains("tedi-sidenav-item--hidden")).toBe(
      true,
    );
  });
  ...
  it("toggleDropdown should focus first dropdown item when opening in collapsed mode", () => {
    ...
    Object.defineProperty(mockTrigger, "offsetParent", {
      value: document.body,
      configurable: true,
    });
  ...
  it("toggleDropdown should focus trigger when closing in collapsed mode", () => {
    ...
    const actualTriggerBtn = fixture.nativeElement.querySelector(
