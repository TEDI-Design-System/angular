...
describe("SideNavDropdownComponent", () => {
  ...
  it("should have wrapper class on host element", () => {
    expect(
      fixture.nativeElement.classList.contains("tedi-sidenav-dropdown-wrapper"),
    ).toBe(true);
  });

  it("should have the base CSS class on ul element", () => {
    expect(dropdownElement.classList.contains("tedi-sidenav-dropdown")).toBe(
      true,
    );
  });
  ...
  it("should have open class when dropdown is open", () => {
    ...
    fixture.detectChanges();
    expect(
      dropdownElement.classList.contains("tedi-sidenav-dropdown--open"),
    ).toBe(true);
  });
