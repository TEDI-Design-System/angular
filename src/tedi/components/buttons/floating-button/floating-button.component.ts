...
export class FloatingButtonComponent implements OnInit {
   ...
   * corners and square right corners. Intended for desktop side placement;
   * on mobile prefer a horizontal button near the bottom, or an icon-only one.
   * Icon-only buttons remain horizontal regardless of this setting.
   *
