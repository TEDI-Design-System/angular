...
export default {
  ...
  argTypes: {
    ...
    axis: {
      ...
      description:
        "`vertical` rotates the button 90° counter-clockwise, with rounded left corners and square right corners. Intended for desktop side placement; on mobile prefer a horizontal button near the bottom, or an icon-only one.",
      table: {
        category: "inputs",
    ...
    <tedi-row [cols]="3" [gapY]="3" alignItems="center">
      ...
      <ng-container *ngFor="let state of pseudoState">
        ...
        <tedi-col style="display: flex; flex-wrap: wrap; align-items: center; gap: 1rem;">
          <button tedi-floating-button position="static" variant="primary" [attr.data-state]="state" [disabled]="state === 'Disabled'">Jäta oma tagasiside</button>
          <tedi-tooltip>
            <tedi-tooltip-trigger>
              <button tedi-floating-button position="static" variant="primary" [attr.data-state]="state" [disabled]="state === 'Disabled'" aria-label="Mine üles">
                <tedi-icon name="arrow_upward" />
              </button>
            </tedi-tooltip-trigger>
            <tedi-tooltip-content>Mine üles</tedi-tooltip-content>
        ...
        <tedi-col style="display: flex; flex-wrap: wrap; align-items: center; gap: 1rem;">
          <button tedi-floating-button position="static" variant="secondary" [attr.data-state]="state" [disabled]="state === 'Disabled'">Jäta oma tagasiside</button>
          <tedi-tooltip>
            <tedi-tooltip-trigger>
              <button tedi-floating-button position="static" variant="secondary" [attr.data-state]="state" [disabled]="state === 'Disabled'" aria-label="Mine üles">
                <tedi-icon name="arrow_upward" />
              </button>
            </tedi-tooltip-trigger>
            <tedi-tooltip-content>Mine üles</tedi-tooltip-content>
