...
describe("ModalService", () => {
  ...
  it("should apply correct panel classes for default config", () => {
    ...
    expect(overlayPane?.classList.contains("tedi-modal-dialog--default")).toBe(
      true,
    );
    expect(overlayPane?.classList.contains("tedi-modal-dialog--sm")).toBe(true);
    expect(overlayPane?.classList.contains("tedi-modal-dialog--center")).toBe(
      true,
    );
    expect(overlayPane?.classList.contains("tedi-modal-dialog--top")).toBe(
      false,
    );
  ...
  it("should apply correct panel classes for custom config", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(overlayPane?.classList.contains("tedi-modal-dialog--small")).toBe(
      true,
    );
    expect(overlayPane?.classList.contains("tedi-modal-dialog--lg")).toBe(true);
    expect(overlayPane?.classList.contains("tedi-modal-dialog--right")).toBe(
      true,
    );
  ...
  it("should not apply width class for custom width values", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(overlayPane?.classList.contains("tedi-modal-dialog--80%")).toBe(
      false,
    );
  ...
  it("should apply fullscreen class when fullscreen is true", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(
      overlayPane?.classList.contains("tedi-modal-dialog--fullscreen"),
    ).toBe(true);
  ...
  it("should apply fullscreen-md class when fullscreen is 'md'", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(
      overlayPane?.classList.contains("tedi-modal-dialog--fullscreen-md"),
    ).toBe(true);
  ...
  it("should apply scroll-page class when scrollBehavior is page", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(
      overlayPane?.classList.contains("tedi-modal-dialog--scroll-page"),
    ).toBe(true);
  ...
  it("should apply left position strategy", () => {
    ...
    const overlayPane = document.querySelector(".cdk-overlay-pane");
    expect(overlayPane?.classList.contains("tedi-modal-dialog--left")).toBe(
      true,
    );
  ...
  it("should set --_tedi-modal-max-width CSS variable when maxWidth is provided", () => {
    ...
    expect(
      overlayElement?.style.getPropertyValue("--_tedi-modal-max-width"),
    ).toBe("800px");
