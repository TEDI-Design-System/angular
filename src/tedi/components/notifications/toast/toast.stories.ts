...
@Component({
  ...
  template: `
    <div [tediVerticalSpacing]="0.5">
      <tedi-row>
        <tedi-col [lg]="12">
          <button tedi-button (click)="showSuccess()">
            Show success toast
          </button>
        </tedi-col>
      </tedi-row>
      <tedi-row>
        <tedi-col>
          <button tedi-button (click)="showWarning()">
            Show warning toast
          </button>
        </tedi-col>
      </tedi-row>
...
class ToastDefaultDemoComponent {
  ...
  showInfo() {
    this.toastService.info(
      "Notice",
      "Some info text that can usually be very long!",
    );
  }
}
...
class ToastIconDemoComponent {
  ...
  showWithCustomIcon() {
    this.toastService.info("With Icon", "Using a custom icon", {
      icon: "info",
    });
  }
}
...
@Component({
  ...
  template: `
    <button tedi-button (click)="showPersistent()">
...
@Component({
  ...
  template: `
    <tedi-row gap="2">
      <tedi-col>
        <button tedi-button (click)="showPauseOnHover()">Pause on hover</button>
      </tedi-col>
      <tedi-col>
        <button tedi-button (click)="showNoPause()">No pause on hover</button>
      </tedi-col>
    </tedi-row>
  `,
})
...
@Component({
  ...
  template: `
    <tedi-row gap="2">
      ...
      <tedi-col>
        <button tedi-button (click)="showAlert()">Error (role=alert)</button>
      </tedi-col>
      <tedi-col>
        <button tedi-button (click)="showNone()">Info (role=none)</button>
      </tedi-col>
    </tedi-row>
  `,
})
