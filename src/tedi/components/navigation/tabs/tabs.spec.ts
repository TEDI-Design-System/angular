...
const simulateOverflow = (fixture: ComponentFixture<HostComponent>) => {
  ...
  const wrapper = fixture.debugElement.query(By.css(".tedi-tabs-list"))
    .nativeElement as HTMLElement;
...
describe("Tabs", () => {
  ...
  it("links triggers and panels via aria-controls/aria-labelledby", () => {
    ...
    const panel = fixture.debugElement.query(
      By.css('[role="tabpanel"]:not([hidden])'),
    ).nativeElement as HTMLElement;
  ...
  it("does not activate disabled tabs", () => {
    ...
    const triggerInstances = fixture.debugElement.queryAll(
      By.directive(TabsTriggerComponent),
    );
    (
      triggerInstances[2].componentInstance as TabsTriggerComponent
    ).handleClick();
    fixture.detectChanges();
    expect(visiblePanelText(fixture)).toEqual(["Content 1"]);
  });
  ...
  describe("overflow", () => {
    it("does not show the More button without overflow", () => {
      const fixture = setup();
      expect(
        fixture.debugElement.query(By.css(".tedi-tabs-list__more")),
      ).toBeNull();
    });
    ...
    it("shows the More button when tabs overflow", () => {
      ...
      expect(
        fixture.debugElement.query(By.css(".tedi-tabs-list__more-btn")),
      ).toBeTruthy();
    });
    ...
    it("excludes the active tab from the dropdown items", () => {
      const fixture = setup();
      simulateOverflow(fixture);
      const list = fixture.debugElement.query(By.directive(TabsListComponent))
        .componentInstance as TabsListComponent;
    ...
    it("re-checks overflow when the set of triggers changes without a resize", () => {
      ...
      fixture.componentRef.setInput("tabIds", [
        "tab-1",
        "tab-2",
        "tab-3",
        "tab-4",
    ...
    it("toggles scroll-fade indicators in scroll mode", () => {
      ...
      const listEl = fixture.debugElement.query(By.css('[role="tablist"]'))
        .nativeElement as HTMLElement;
      ...
      const wrapper = fixture.debugElement.query(By.css(".tedi-tabs-list"))
        .nativeElement as HTMLElement;
      expect(wrapper.classList.contains("tedi-tabs-list--fade-start")).toBe(
        true,
      );
