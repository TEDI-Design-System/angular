...
export const WithActions: Story = {
  render: () => ({
    ...
    template: `
      <div style="max-width: 360px"><div [tediVerticalSpacing]="1">
        <tedi-table-card layout="vertical">
          <div tedi-table-card-row label="Kuupäev" value="22.03.2029 – 29.03.2029"></div>
          <div tedi-table-card-row label="Kellaaeg" value="11:14"></div>
          <div tedi-table-card-row label="Kestus" value="6 min"></div>
          <div tedi-table-card-row label="Asukoht" value="Tallinn"></div>
        ...
        <tedi-table-card layout="vertical">
          <div tedi-table-card-row label="Kuupäev" labelFor="booking-date">
            <tedi-date-field
          ...
          <div tedi-table-card-row label="Kellaaeg" labelFor="booking-time">
            <tedi-time-field inputId="booking-time" [(ngModel)]="booking.time" />
          </div>
          <div tedi-table-card-row label="Kestus" labelFor="booking-duration">
            <tedi-input-group>
              <tedi-form-field>
                <input tedi-text-field id="booking-duration" [(ngModel)]="booking.duration" />
              </tedi-form-field>
          ...
          <tedi-table-card-actions>
            <button tedi-button variant="neutral">Katkesta</button>
            <button tedi-button variant="primary">Salvesta</button>
          </tedi-table-card-actions>
        </tedi-table-card>
