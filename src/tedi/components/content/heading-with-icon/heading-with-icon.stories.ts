  ...
  render: () => ({
    template: `
      <div [tediVerticalSpacing]="1">
        <tedi-heading-with-icon icon="assignment_ind" headingColor="brand" iconColor="brand">
          My family physician
        </tedi-heading-with-icon>
        <tedi-heading-with-icon icon="assignment_ind">
          My family physician
        </tedi-heading-with-icon>
      </div>
    `,
    ...
    template: `
      <div style="display: flex; flex-wrap: wrap; gap: 1rem; align-items: flex-start">
        ...
        <tedi-card background="brand-primary" style="width: 300px">
          <tedi-card-content>
            <div [tediVerticalSpacing]="0.5">
              <tedi-heading-with-icon icon="assignment_ind" headingColor="white" iconColor="white">
                My statement of intention
              </tedi-heading-with-icon>
              <div>
