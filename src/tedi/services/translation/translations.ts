...
export const translationsMap = {
  ...
  "breadcrumbs.show-more": {
    description:
      "Label for the collapsed-crumbs ellipsis button in breadcrumbs",
    components: ["Breadcrumbs"],
    et: "Näita rohkem",
    en: "Show more",
    ru: "Показать больше",
  ...
  "file-attachment.uploading": {
    description:
      "Default hint label shown under the progress bar in Attachment while a file is being uploaded",
  ...
  "table.filter-apply": {
    description: "Apply action in the built-in column filter popover footer",
    components: ["Table"],
    et: "Filtreeri",
    en: "Apply",
    ru: "Применить",
  ...
  "table.filter-clear": {
    description: "Clear action in the built-in column filter popover footer",
    components: ["Table"],
    et: "Tühista",
    en: "Clear",
    ru: "Сбросить",
  ...
  "table.reorder.pickup": {
    description:
      "Live region message when a column is picked up for keyboard reordering",
    components: ["Table"],
    et: (column: string) =>
  ...
  "table.reorder.move": {
    description:
      "Live region message while a picked-up column is moved between positions",
    components: ["Table"],
  ...
  "table.row-reorder.pickup": {
    description:
      "Live region message when a row is picked up for keyboard reordering",
    components: ["Table"],
    et: (position: number) =>
  ...
  "table.row-reorder.move": {
    description:
      "Live region message while a picked-up row is moved between positions",
    components: ["Table"],
  ...
  "pagination.page-status": {
    ...
    et: (page?: number, total?: number) =>
      `Lehekülg ${page ?? 0} / ${total ?? 0}`,
    en: (page?: number, total?: number) => `Page ${page ?? 0} of ${total ?? 0}`,
    ru: (page?: number, total?: number) =>
      `Страница ${page ?? 0} из ${total ?? 0}`,
  },
  ...
  "date-field.cancel": {
    description: "Label for the cancel button in the mobile date picker modal.",
    components: ["DateField"],
    et: "Tühista",
    en: "Cancel",
    ru: "Отмена",
  ...
  "date-time-field.time-heading": {
    description:
      "Heading rendered above the time picker in the date-time field.",
  ...
  "time-picker.times": {
    description:
      "Aria label for the dropdown listbox of time slots in the time picker.",
    components: ["TimePicker"],
    et: "Kellaajad",
    en: "Times",
    ru: "Время",
