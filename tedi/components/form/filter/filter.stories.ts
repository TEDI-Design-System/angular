    ...
    template: `
      <div class="flex flex-column gap-4">
        <div>
          ...
          <div class="flex flex-column gap-2">
            <div class="flex flex-wrap gap-2">
              <tedi-filter text="Raviasutus" [multiselect]="true" [options]="options" [(values)]="compactValues1" [searchable]="true" [showSelectAll]="true" [showClear]="true" />
              <tedi-filter text="Teenus" [options]="teenusOptions" />
            </div>
            <div class="flex flex-wrap gap-2">
              <tedi-filter text="Raviasutus" variant="secondary" [multiselect]="true" [options]="options" [(values)]="compactValues2" [searchable]="true" [showSelectAll]="true" [showClear]="true" />
        ...
        <div>
          ...
          <div class="flex flex-column gap-2">
            <div class="flex flex-wrap gap-2">
              <tedi-filter text="Raviasutus" [options]="options" />
              <tedi-filter text="Teenus" [options]="teenusOptions" />
            </div>
            <div class="flex flex-wrap gap-2">
              <tedi-filter text="Raviasutus" variant="secondary" [options]="options" />
              <tedi-filter text="Teenus" variant="secondary" [options]="teenusOptions" />
            </div>
          </div>
        </div>
