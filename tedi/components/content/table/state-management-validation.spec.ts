...
function sortButton(fixture: ComponentFixture<HostComponent>): HTMLButtonElement {
  return fixture.nativeElement.querySelector(
    "button.tedi-table-header-button",
  ) as HTMLButtonElement;
}

function headerCellAriaSort(fixture: ComponentFixture<HostComponent>): string | null {
  return (
